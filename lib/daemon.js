...
var daemon = function(config){
  ...
  Object.defineProperties(this,{
    ...
    _daemondirectory: {
      ...
      writable: true,
      configurable: false,
      value: config.daemondirectory ? path.resolve(config.daemondirectory) : _directory
    },
    ...
    workingdirectory: {
      ...
      writable: true,
      configurable: false,
      value: config.workingdirectory ? path.resolve(config.workingdirectory) : process.cwd()
    },
