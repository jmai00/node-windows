...
var daemon = function(config){
  ...
  Object.defineProperties(this,{
    ...
    stopparentfirst: {
      ...
      writable: false,
      configurable: false,
      value: config.stopparentfirst || false
    },
    ...
    _directory: {
      ...
      writable: true,
      configurable: false,
      value: config.script ? path.dirname(config.script) : null
    },
    ...
    _daemondirectory: {
      ...
      writable: true,
      configurable: false,
      value: config.daemondirectory ? path.dirname(config.daemondirectory) : _directory
    },
    ...
    directory: {
      ...
      value: function(dir){
        ...
        return path.resolve(path.join(this._daemondirectory,daemonDirName));
      }
    },
     ...
     * attributes may be helpful.
     *
     * The `logOnAs` attribute is an object with four keys: `domain`,`account`, `password`, `allowServiceLogon` and `mungeCredentialsAfterInstall`.
    ...
    workingdirectory: {
      ...
      writable: true,
      configurable: false,
      value: config.workingdirectory ? path.dirname(config.workingdirectory) : process.cwd()
    },
